...
//
    ...
    void defaultPuck() {
        ...
        assertEquals(300, testPuck.getCenterY(),
    ...
    void move_move_test_y() {
        ...
        testPuck.setSpeed(5);
        testPuck.move();
        assertEquals(305, testPuck.getCenterY(),
    ...
    void reset() {
        ...
        assertEquals(5, testPuck.getSpeed(),
                "Test Puck should have a speed of 5 after reset");
        double d = testPuck.getDirection();
        assertTrue((d >= -45 && d < 45) || (d >= 135 && d < 225),
                "Test Puck should be pointing roughly at player 1 or player 2");
    }
